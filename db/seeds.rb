...
User.create(first_name: "Susan", last_name: "DeGeneres", email: "susan@susan.com", password: "susan")
User.create(first_name: "Quynh", last_name: "To Tuan", email: "quynh@quynh.com", password: "quynh")
